...
HELIX_EXTERN const char* HELIX_PRINT_VALUE_STR;
...
HELIX_EXTERN VALUE* HELIX_RARRAY_PTR(VALUE array);
HELIX_EXTERN const VALUE* HELIX_RARRAY_CONST_PTR(VALUE array);
